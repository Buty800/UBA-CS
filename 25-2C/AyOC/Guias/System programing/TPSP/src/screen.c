...
void screen_draw_layout(void) {
  uint8_t textAttr = C_BG_BLUE | C_FG_WHITE;
  screen_draw_box(0, 0, ROWS, COLS, ' ', C_BG_BLUE);

  print("System Programming - Modo Protegido", 2, 1, textAttr);

  print("Integrantes: Ignacio Romero - Bautista De Suto - Silvano Picard", 2, 5, textAttr);
  print("Grupo: Nacho y sus seg faluts", 2, 7, textAttr);
}

...
; registros y pila: x1[EDI], x2[ESI], x3[EDX], x4[ECX], x5[R8D], x6[R9D], x7[RSP+8], x8[RSP+16]
alternate_sum_8:
...
product_2_f:
  ...
  cvttsd2si EAX, XMM0      ; double → int truncado

  ; cvtsi2ss XMM1, ESI      ; float XMMI = (float) EDI
  ; mulss   XMM0, XMM1      ; XMM0 = XMM0 * XMM1
  ; cvttss2si EAX, XMM0     ; int EAX = (int) XMM0 
...
;	, x5[R9D], f5[XMM4], x6[RBP+8], f6[XMM5], x7[RBP+16], f7[XMM6], x8[RBP+24], f8[XMM7],
;	, x9[RBP+32], f9[RBP+40]
product_9_f:
	;prologo
	push rbp
  ...
  cvtsi2sd XMM4, R8D 
  cvtsi2sd XMM5, R9D
  cvtsi2sd XMM6, [RSP+16]
  cvtsi2sd XMM7, [RSP+24]
  cvtsi2sd XMM8, [RSP+32]
  cvtsi2sd XMM9, [RSP+40]  

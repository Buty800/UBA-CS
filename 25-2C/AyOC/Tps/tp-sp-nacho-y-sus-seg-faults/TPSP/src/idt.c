...
void idt_init() {
  ...
  // IRQs: timer y teclado (nivel 0)
  IDT_ENTRY0(32);   // _isr32
  IDT_ENTRY0(33);   // _isr33

  // Syscalls nivel 3
  IDT_ENTRY3(88);   // _isr88
  IDT_ENTRY3(98);   // _isr98
}
